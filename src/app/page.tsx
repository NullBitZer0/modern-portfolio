          ...
          >
            ...
            <div className="w-full space-y-4 text-left text-base leading-relaxed text-gray-600 dark:text-gray-400 sm:text-lg md:text-xl">
              ...
              <p>
                ...
                and practical user applications through data science, MLOps, cloud engineering, and automation-driven solutions.
              </p>
            </div>
            ...
            <div className="mb-16 mt-16 w-full text-left">
              ...
              <div className="space-y-6">
                ...
                <Link href="/book-recommendation" className="group block rounded-xl border border-gray-200 dark:border-gray-800 p-6 sm:p-8 transition-all hover:border-gray-400 dark:hover:border-gray-600 hover:bg-gray-50/50 dark:hover:bg-zinc-900/50">
                  <div className="flex items-center justify-between mb-2">
                    <div className="flex items-center gap-2">
            ...
            {/* ASCII Footer */}
            <div className="mt-16 mb-8 hidden sm:flex w-full justify-center opacity-30 hover:opacity-100 transition-opacity duration-500">
              <pre className="text-[0.4rem] sm:text-[0.5rem] md:text-[0.6rem] leading-tight font-bold tracking-tight text-black dark:text-white font-mono text-center">
