...
export default function NvidiaReportAnalysis() {
    return (
            ...
            <div className="max-w-5xl mx-auto">
                ...
                >
                    ...
                    <h1 className="text-3xl md:text-5xl font-bold mb-4">
                        <span className="text-gray-400">NVIDIA</span> Report Analysis
                    </h1>
                    <p className="text-gray-400 dark:text-gray-500 max-w-2xl mx-auto text-sm md:text-base">
                        NLP-based financial report analysis using FinBERT sentiment scoring, web scraping, LSTM OHLC prediction, and real-time Telegram alerts.
                    </p>
                </motion.div>
